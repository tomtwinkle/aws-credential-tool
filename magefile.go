...
func Build() error {
	...
	var buildEnvList = []BuildEnv{
		{"linux", "386", "actool", "gz", "actool-%s.rev-%s-i386_linux.gz"},
		{"linux", "amd64", "actool", "gz", "actool-%s.rev-%s-arm64_linux.gz"},
		{"darwin", "386", "actool", "gz", "actool-%s.rev-%s-i386_mac.gz"},
		{"darwin", "amd64", "actool", "gz", "actool-%s.rev-%s-arm64_mac.gz"},
		{"windows", "386", "actool.exe", "zip", "actool-%s.rev-%s_win32.zip"},
		{"windows", "amd64", "actool.exe", "zip", "actool-%s.rev-%s_win64.zip"},
	}
